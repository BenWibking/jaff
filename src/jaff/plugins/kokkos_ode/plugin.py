...
"""
    ...
    # Generate temperature/internal energy helpers with fixed gamma = 5/3
    temperature_func = """// Temperature/internal energy helpers (gamma = 5/3) generated by JAFF
// We assume a monatomic ideal gas mixture with constant adiabatic index gamma=5/3.
// Mean molecular weight is still computed from composition via species masses.
