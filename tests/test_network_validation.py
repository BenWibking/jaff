...
class TestNetworkValidation:
    ...
    def test_check_sink_sources_no_issues(self):
        ...
        try:
            ...
            warning_calls = [call for call in mock_print.call_args_list 
                           if 'Sink:' in str(call) or 'Source:' in str(call) or 'WARNING: sink' in str(call) or 'WARNING: source' in str(call)]
    ...
    def test_check_sink_sources_with_sink(self):
        ...
        try:
            ...
            sink_warnings = [call for call in mock_print.call_args_list 
                           if 'Sink:' in str(call) and 'He' in str(call)]
            assert len(sink_warnings) > 0
            
            # Check that general sink warning was printed
            general_warnings = [call for call in mock_print.call_args_list 
    ...
    def test_check_sink_sources_with_source(self):
        ...
        try:
            ...
            source_warnings = [call for call in mock_print.call_args_list 
    ...
    def test_check_recombinations_no_issues(self):
        ...
        try:
            ...
            recomb_warnings = [call for call in mock_print.call_args_list 
    ...
    def test_check_isomers_no_issues(self):
        ...
        try:
            ...
            isomer_warnings = [call for call in mock_print.call_args_list 
    ...
    def test_check_unique_reactions_no_duplicates(self):
        ...
        try:
            ...
            duplicate_warnings = [call for call in mock_print.call_args_list 
    ...
    def test_validation_with_dummy_species_ignored(self):
        ...
        try:
            ...
            dummy_warnings = [call for call in mock_print.call_args_list 
                            if ('Sink:' in str(call) or 'Source:' in str(call)) and 'dummy' in str(call)]
